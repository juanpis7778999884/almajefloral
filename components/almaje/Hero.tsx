    ...
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden py-12 px-4">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <a
            href="#tienda"
            className="group relative inline-flex items-center gap-3 px-8 py-4 bg-[var(--primary)] text-[var(--primary-foreground)] font-body font-semibold text-lg rounded-full transition-all hover:scale-105 hover:shadow-lg overflow-hidden"
            style={{ borderRadius: "255px 15px 225px 15px/15px 225px 15px 255px" }}
          >
            <span className="relative z-10">Ver Colección</span>
            <svg className="w-5 h-5 relative z-10 transition-transform group-hover:translate-x-1" viewBox="0 0 20 20" fill="currentColor">
          ...
          <a
            href="#personalizar"
            className="inline-flex items-center gap-2 px-8 py-4 border-2 border-dashed border-[var(--primary)] text-[var(--primary)] font-body font-semibold text-lg rounded-full transition-all hover:bg-[var(--primary)] hover:text-[var(--primary-foreground)] hover-wobble"
