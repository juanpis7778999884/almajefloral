        ...
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <nav className="space-y-3">
              ...
              <a href="https://wa.me/3115510169" target="_blank" rel="noopener noreferrer" className="block font-body text-[var(--muted-foreground)] hover:text-[var(--primary)] transition-colors">
                Contacto
              </a>
            </nav>
          </div>
