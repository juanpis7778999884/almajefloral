        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="mt-10">
              <a
                href="#personalizar"
                className="inline-flex items-center gap-3 px-8 py-4 bg-[var(--primary)] text-[var(--primary-foreground)] font-body font-bold transition-all hover:scale-105 hover:shadow-lg"
                style={{ borderRadius: "255px 15px 225px 15px/15px 225px 15px 255px" }}
              >
